...
<context>
    ...
    <message>
        ...
        <translation>PyrexCoinのブロックチェーンを初期化しますか？</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ディスク容量節約モードを有効にすると、使用するディスク容量はずっと小さくなりますが、通信帯域の使用量は通常モードと変わりません。ただし、PyrexCoinのネットワークの安全性を高める意味で、完全なブロックチェーンの全体を保存することが推奨されています。もしあなたのコンピュータのディスク容量が小さい場合は、このオプションを使用してください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>PyrexCoinの採掘をすることでネットワークの安全性が高まり、また提供した計算量の対価として低い確率ですが報酬が得られます。このオプションは、あなたのコンピュータが電源に接続されていてなおかつアイドル状態の場合に、自動的にPyrexCoinの採掘を行うことを許可します。あなたが作業を再開すると、採掘は停止されます。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>PyrexCoinネットワークと通信するためにウォレットはPyrexCoinノードに接続されている必要があります。プライバシーを最大限に保護するため自分自身のノードを走らせることが推奨されています。
...
<context>
    ...
    <message>
        ...
        <translation>PyrexCoinの開発は寄付のみによって支えられています</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>取引には少額の手数料がかかります。このオプションはその手数料に加えて、手数料の何パーセントかをPyrexCoinの開発チームへの寄付として支払うことを許可します。例えば自動寄付の割合が50%で、取引の手数料が0.005 PYXであった場合、0.0025 PYXが開発チームへの寄付として取引に上乗せされます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Pyrexcoinを使う</translation>
    </message>
    <message>
