...
public:
    enum LogLevel {
        LogLevel_Silent = Pyrexcoin::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Pyrexcoin::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Pyrexcoin::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Pyrexcoin::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Pyrexcoin::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Pyrexcoin::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Pyrexcoin::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Pyrexcoin::WalletManagerFactory::LogLevel_Max,
    };
...
private:
    ...
    Pyrexcoin::WalletManager * m_pimpl;
    QMutex m_mutex;
