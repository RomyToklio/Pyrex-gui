...
AddressBook::AddressBook(Pyrexcoin::AddressBook *abImpl,QObject *parent)
...
QList<Pyrexcoin::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Pyrexcoin::AddressBookRow * AddressBook::getRow(int index) const
{
