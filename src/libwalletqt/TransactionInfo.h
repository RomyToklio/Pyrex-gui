...
public:
    enum Direction {
        Direction_In  =  Pyrexcoin::TransactionInfo::Direction_In,
        Direction_Out =  Pyrexcoin::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Pyrexcoin::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Pyrexcoin::TransactionInfo * m_pimpl;
