...
; As of version 0.12.0.0, the Pyrexcoin .exe files do not carry version info anyway in their .exe headers.
...
Root: HKCU; Subkey: "Software\pyrexcoin-project\pyrexcoin-core"; ValueType: string; ValueName: "daemonFlags"; ValueData: {code:DaemonFlags};
