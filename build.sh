...
if [ "$platform" == "darwin" ]; then
    BIN_PATH=$BIN_PATH/pyrexcoin-wallet-gui.app/Contents/MacOS/
...
$QMAKE ../pyrexcoin-wallet-gui.pro "$CONFIG" || exit
$MAKE || exit 

# Copy pyrexcoind to bin folder
